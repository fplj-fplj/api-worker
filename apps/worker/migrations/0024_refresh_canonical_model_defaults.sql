...
VALUES
  ('openai/gpt-5', 'openai/gpt-5', NULL, '^(?:openai/)?gpt-5(?:(?:-chat(?:-latest)?|-(?:high|low|medium)|-\d{4}-\d{2}-\d{2}))?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5-mini', 'openai/gpt-5-mini', NULL, '^(?:openai/)?gpt-5-mini(?:-\d{4}-\d{2}-\d{2})?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5-nano', 'openai/gpt-5-nano', NULL, '^(?:openai/)?gpt-5-nano(?:-\d{4}-\d{2}-\d{2})?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5-pro', 'openai/gpt-5-pro', NULL, '^(?:openai/)?gpt-5-pro(?:-\d{4}-\d{2}-\d{2})?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5-codex', 'openai/gpt-5-codex', NULL, '^(?:openai/)?gpt-5-codex(?:(?:-(?:high|low|medium|spark))?(?:-openai-compact)?)?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('openai/gpt-5.1', 'openai/gpt-5.1', NULL, '^(?:openai/)?gpt-5\.1(?:\.\d+)*(?:(?:-chat(?:-latest)?|-high|-\d{4}-\d{2}-\d{2}))?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5.1-codex', 'openai/gpt-5.1-codex', NULL, '^(?:openai/)?gpt-5\.1(?:\.\d+)*-codex(?:-openai-compact)?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5.1-codex-mini', 'openai/gpt-5.1-codex-mini', NULL, '^(?:openai/)?gpt-5\.1(?:\.\d+)*-codex-mini(?:-openai-compact)?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5.1-codex-max', 'openai/gpt-5.1-codex-max', NULL, '^(?:openai/)?gpt-5\.1(?:\.\d+)*-codex-max(?:-openai-compact)?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5.2', 'openai/gpt-5.2', NULL, '^(?:openai/)?gpt-5\.2(?:\.\d+)*(?:(?:-chat(?:-latest)?|-(?:high|low|medium|xhigh|openai-compact)|\((?:auto|high|low|medium|xhigh)\)|-\d{4}-\d{2}-\d{2}))*$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5.2-pro', 'openai/gpt-5.2-pro', NULL, '^(?:openai/)?gpt-5\.2(?:\.\d+)*-pro(?:-\d{4}-\d{2}-\d{2})?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('openai/gpt-5.2-codex', 'openai/gpt-5.2-codex', NULL, '^(?:openai/)?gpt-5\.2(?:\.\d+)*-codex(?:-openai-compact)?$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  ('openai/gpt-5.4', 'openai/gpt-5.4', NULL, '^(?:openai/)?gpt-5\.4(?:\.\d+)*(?:(?:-(?:high|low|medium|xhigh|openai-compact)|\((?:high|low|medium|xhigh)\)|-\d{4}-\d{2}-\d{2}))*$', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
